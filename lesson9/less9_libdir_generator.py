...
class Library:
    ...
    # Используем генератор. Убераем список и return, ставим yield
    def books(self):
        """List of books"""
    ...
    # Добавляем спец функцию __iter__() для обращения к генератору.
    def __iter__(self):
        return self.books()
...
lib = Library(r'D:\EDU\PYTHON\homework\library_dir\library')
